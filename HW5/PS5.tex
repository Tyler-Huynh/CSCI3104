...
&= \lim_{n \to \infty} \frac{2^{\frac{n+1}{3}}}{2^{n + 1}} * \frac{2^{n}}{2^{\frac{n}{3}}} \\
&= \lim_{n \to \infty} \frac{2^{\frac{n}{3}} * 2^{\frac{1}{3}}} {2^{n} * 2} * \frac{2^{n}}{2^{\frac{n}{3}}} \\
&= \lim_{n \to \infty} \frac{2^{\frac{1}{3}}}{2} \\
&= \lim_{n \to \infty} \frac{\sqrt[3]2}{2} \\
&= \frac{\sqrt[3]2}{2} \le 1
\end{align*} 
\end{proof}
\end{enumerate}
