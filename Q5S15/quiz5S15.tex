...
\section{Standard 15: Analyzing Code---Nested Dependent Loops}
...
\textbf{Notice (because they may not be what you think!): } 
\begin{itemize}
\item the lower bound on $j$ in the inner loop, and 
\item the upper bound on $j$ in the inner loop
\end{itemize}

\begin{algorithm}
\caption{Nested Algorithm 2}\label{alg:Nested2}
\begin{algorithmic}[1]
\Procedure{Foo7}{$\text{Integer } n$}
...
\includegraphics[width=0.9\textwidth]{Huynh_Q5S15P1_CSCI3104.pdf} \\
\includegraphics[width=0.9\textwidth]{Huynh_Q5S15P2_CSCI3104.pdf} \\
The final answer is $T(n) = \Theta(n^2)$
\end{proof}
