...
Suppose you are going to solve this problem by dynamic programming; this can be done with a one-dimensional table $T$. \textbf{Clearly define} what subproblems $T[i]$ corresponds to, and which other indices $j$ need to be considered when determining the value of $T[i]$.
...
\includegraphics[width=0.9\textwidth]{Q8S21P1.pdf} \\
\includegraphics[width=0.9\textwidth]{Q8S21P2.pdf} \\
\end{proof}
\end{required}
