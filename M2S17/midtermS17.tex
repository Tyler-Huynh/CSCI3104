...
Quiz Code (enter in Canvas to get access to the LaTeX template) \dotfill \textbf{1cHavsfdh0}
...
\section{Standard \standard: Solving Recurrences Using Unrolling}

\setcounter{required}{\standard-1}
\begin{required} 
\textbf{Using the unrolling method}, find a suitable function $f(n)$ such that $T(n) \in \Theta(f(n))$. Show all work.
...
\includegraphics[width=0.9\textwidth]{M2S17P1.pdf} \\
\includegraphics[width=0.9\textwidth]{M2S17P2.pdf}
