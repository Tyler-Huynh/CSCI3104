...
\textbf{Description of modifications:}\\
...
2. The next step would be to traverse through these nodes further in order to find the ones with the shortest distance, thus making it our final target node.\\
