...
Quiz Code (enter in Canvas to get access to the LaTeX template) \dotfill \textbf{bsuqP8j6Bi}
...
\section{Standard \standard: Dynamic Programming: Writing Down Recurrence}
...
\includegraphics[width=0.9\textwidth]{M2S22.pdf}
