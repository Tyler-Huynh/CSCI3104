...
We will now pop off the vertices of \{C, D\} from our priority queue and check if it creates a cycle, which it does not and add it to our tree of G. \\
\begin{center}
Priority Queue: [\{B, C\}, \{G, F\}, \{G, E\}, \{B, E\}]\\
Minimum Weight Spanning Tree $G$: [\{G, B\}, \{A, G\}, \{A, B\}, \{E, F\}, \{E, D\, \{C, D\}}]
\end{center}
