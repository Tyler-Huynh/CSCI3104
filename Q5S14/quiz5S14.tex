...
\section{Standard 14: Analyzing Code---Independent Nested Loops}
...
\begin{itemize}
\item the upper bound on $i$ in the outer loop, and 
...
\includegraphics[width=0.9\textwidth]{Huynh_Q5S14_CSCI3104.pdf} \\
\includegraphics[width=0.9\textwidth]{Huynh_Q5S14P2_CSCI3104.pdf} \\
Final answer is $T(n) = \Theta(n^3)$
\end{proof}
