...
Quiz Code (enter in Canvas to get access to the LaTeX template) \dotfill \textbf{OLKYQ}
...
\begin{required} 
Let $f(n) = n^{\ln n}$ and $g(n) = 7^n$. Determine the relationship that best applies: $f(n) \in O(g(n)), f(n) \in \Theta(g(n))$, or $f(n) \in \Omega(g(n))$. Prove your answer.
Note that you are expected to spell out \textbf{all Calculus details} at the level of Calculus I--II.
\end{required}

\begin{proof}[Answer] Using the \textbf{root test:}
% YOUR ANSWER HERE
% Either type your answer in above, or uncomment the \includegraphics command
% and use it to insert an approprate image. Try experimenting with the scale 
% 0.9 the width option to resize your image if necessary.

\includegraphics[width=0.9\textwidth]{Huynh_Q5S13_CSCI3104.pdf}
\end{proof}
